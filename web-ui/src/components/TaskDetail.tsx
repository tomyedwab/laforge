            ...
            <div class="task-detail-header">
              <div class="task-detail-title-section">
                ...
                <div class="task-detail-badges">
                  <div
                    class={`connection-status small ${isConnected ? 'connected' : 'disconnected'}`}
                  >
                          ...
                          {reviews.map(review => (
                            ...
                            >
                              <div class="review-header">
                                <span
                                  class={`review-status status-${review.status}`}
                                >
                                  {review.status}
                                </span>
